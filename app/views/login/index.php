    ...
    <div class="back">
        <div class="logincontainer">
            ...
            <div class="emailcontainer" id="emailcontainer">
                ...
                <input class="emailinput" type="email" placeholder="Email" name="emailLog" id="emailinput" onchange=checkEmail() required>
            </div>
            <p id="emailInvalid"></p>
            <h4>Password</h4>
        ...
        <button type="submit" class="login" id="login" disabled>Login</button>
        </form>
    </div>
</body>
</html>